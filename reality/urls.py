...
urlpatterns = [
    ...
    path('look_like/', main_views.add_parameter6_look_like, name='look_like'),
    path('behavior/', main_views.add_parameter7_behavior, name='behavior'),
    path('thoughts_direction/', main_views.add_parameter8_thoughts_direction, name='thoughts_direction'),
