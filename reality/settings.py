...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'main', 'templates', 'parameters_forms'),
            os.path.join(BASE_DIR, 'main', 'templates', 'registration'),
            os.path.join(BASE_DIR, 'main', 'templates', 'show'),
            ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'test123testZarina@gmail.com'
EMAIL_HOST_PASSWORD = 'lbfo gytb tcae agzz'
